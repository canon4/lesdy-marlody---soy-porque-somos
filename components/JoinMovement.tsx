      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="text-white pt-8">
            <h2 className="text-white font-bold tracking-wider uppercase text-sm mb-4">Únete al movimiento</h2>
            <h3 className="text-4xl md:text-5xl font-extrabold mb-6">Tu territorio cuenta</h3>
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-white/80">
                            Tu información nos ayuda a identificar las necesidades específicas de cada vereda y municipio.
                        </p>
                    </div>
                </div>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="name" className="block text-sm font-bold text-textdark mb-1">Nombre Completo</label>
                  <input 
                    type="text" 
                    id="name" 
                    name="name" 
                ...
                <div>
                  <label htmlFor="whatsapp" className="block text-sm font-bold text-textdark mb-1">Número de WhatsApp</label>
                  <input 
                    type="tel" 
                    id="whatsapp" 
                    name="whatsapp" 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label htmlFor="municipio" className="block text-sm font-bold text-textdark mb-1">Municipio</label>
                  <input 
                    type="text" 
                    id="municipio" 
                    name="municipio" 
                ...
                <div>
                  <label htmlFor="vereda" className="block text-sm font-bold text-textdark mb-1">Vereda / Barrio</label>
                  <input 
                    type="text" 
                    id="vereda" 
                    name="vereda" 
              ...
              <div className="space-y-4 pt-2">
                <div>
                    <span className="block text-sm font-bold text-textdark mb-2">¿Vota Curul de Paz?</span>
                ...
                <div>
                    <span className="block text-sm font-bold text-textdark mb-2">¿Quiere apoyar la campaña?</span>
                    <div className="flex gap-4">
                        {['Si', 'No'].map((opt) => (
                            <button
                                key={`apoya-${opt}`}
              ...
              <div className="pt-6">
                ...
                {/* Nota de IA / Mapa de Calor */}
                <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-100 flex items-start gap-2">
                    <CheckCircle2 size={16} className="text-earth shrink-0 mt-0.5" />
                    <p className="text-xs text-textmuted leading-tight">
                        <strong>Nota:</strong> Esto alimenta tu mapa de calor electoral y el software de IA para optimizar nuestras visitas al territorio.
                    </p>
                </div>
              </div>
